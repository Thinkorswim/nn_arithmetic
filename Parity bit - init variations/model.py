...
def create_dense_model(input_size):
    ...
    model.add(Dense(layer_size, activation="relu", kernel_initializer=initializers.glorot_normal(seed=0), bias_initializer=initializers.zeros(), input_shape=(input_size,)))
